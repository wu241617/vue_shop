					...
					<el-table :data="manyTabData" border stripe>
						...
						<el-table-column label="操作">
							<template slot-scope="scope">
								...
								<el-button type="danger" class="el-icon-edit" size="mini" @click="removeParams(scope.row.attr_id)">删除</el-button>
							</template>
						</el-table-column>
					</el-table>
				</el-tab-pane>
	...
	export default {
		...
		methods: {
			...
			async handleInputConfirm(row) {
				...
				if (res.meta.status !== 200) {
					return this.$message.error('t添加参数项失败!');
				}
